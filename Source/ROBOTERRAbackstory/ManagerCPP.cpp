...
AManagerCPP::AManagerCPP()
{
	...
	ConstructorHelpers::FClassFinder<AActor> aster_bp(TEXT("/Game/Blueprint/NeededBP/BPAsterCPP"));
	ConstructorHelpers::FClassFinder<AActor> power_bp(TEXT("/Game/Blueprint/PowerUp"));
	ConstructorHelpers::FClassFinder<AActor> enemy_bp(TEXT("/Game/Blueprint/NeededBP/BPShuttleCPP"));
...
void AManagerCPP::BeginPlay()
{
	...
	GetWorld()->GetTimerManager().SetTimer(timer, this, &AManagerCPP::SpawnSMTH, 6.5, true, 6);
